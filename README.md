if game.PlaceId == 2753915549 or game.PlaceId == 4442272183 or game.PlaceId == 7449423635 then
  ...
  wait(10)
      ...
      do
          local ui = game.CoreGui:FindFirstChild("ICYGUI")
          if ui then
              ui:Destroy()
          end
      end
  ...
  elseif placeId == 7449423635 then
      ...
      local sxhub = library:AddWindow("Icy_z | Bloxfruit!",Enum.KeyCode.RightControl)
  ...
  set:AddLabel("Setting")
      ...
      set:AddButton("Copy link Icy_z Discord ",function()
      setclipboard("")
  end)
  ...
  wait(10)
      ...
      --
      local RenUi = library:AddWindow("Icy_z Hub | King Legacy",Enum.KeyCode.RightControl)
      --
