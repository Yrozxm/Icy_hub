        ...
        if UserInputService.TouchEnabled and not UserInputService.KeyboardEnabled then
            ...
            FeariseToggle.MouseButton1Click:Connect(function()
                for _, guiObject in ipairs(game:GetService("CoreGui"):GetChildren()) do
                    if guiObject.Name == "Icy_zHub" and guiObject:IsA("ScreenGui") then
...
local Window = Fluent:CreateWindow({
    Title = "Icy_z Hub 🐀 " .. " | ".."BlueLock : Rival".." | ".."[Version 1]",
    SubTitle = "by Icy_z/Leen",
    TabWidth = 160,
...
do
    ...
    Function_Storage.CreateFeariseHubMobileToggle = function()
		...
		feariseHubMobile.Name = "Icy_zHubMobile"
...
SaveManager:SetFolder("Icy_z Hub")
InterfaceManager:SetFolder("Icy_z Hub")
